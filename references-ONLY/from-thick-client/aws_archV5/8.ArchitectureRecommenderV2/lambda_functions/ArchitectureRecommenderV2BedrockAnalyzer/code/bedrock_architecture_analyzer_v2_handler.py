...
def build_architecture_prompt(consolidated_data: Dict[str, Any]) -> str:
    ...
    code_analysis = consolidated_data.get('code_analysis_v3') or {}
...
def call_bedrock(prompt: str) -> str:
    """Call AWS Bedrock Claude 3.5 Sonnet - REAL API CALL, NO MOCKS"""
    request_body = {
    ...
    print(f"Bedrock response received: {len(ai_text)} characters")
    return ai_text
