"""
Code Analysis Repository - MongoDB Implementation.

Stores Code Analysis artifacts in MongoDB.
Implements BaseArtifactRepository interface.

To switch to DynamoDB later:
1. Create code_analysis_repo_dynamodb.py implementing same interface
...
class CodeAnalysisRepository(BaseArtifactRepository):
    """
    MongoDB implementation of Code Analysis artifact storage.
    """
...
def _get_sync_collection():
    """Get the code_analysis collection (sync)."""
    from config.settings import settings
